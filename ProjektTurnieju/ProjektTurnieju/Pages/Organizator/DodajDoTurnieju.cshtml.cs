...
{
    public class DodajDoTurniejuModel : PageModel
    {
		private readonly ProjektTurnieju.Data.TurniejDBContext _context;

		public DodajDoTurniejuModel(ProjektTurnieju.Data.TurniejDBContext context)
		{
			_context = context;
		}
		...
		public async Task<IActionResult> OnGetAsync(int id, int idTurnieju)
		{
			...
			var turniej = await _context.Turniej.FirstOrDefaultAsync(m => m.Id == idTurnieju);
